! function(a, b) {
	...
	function j(a, b) {
		if (!(!E.debug || b && b.isInnerInvoke)) {
			var c = p[a];
			c && ( a = c), b && b._complete &&
			delete b._complete, console.log('"' + a + '",', b || "")
		}
	}
		...
		return o = {
			...
			getNetworkType : function(a) {
				var b = function(a) {
					...
					if (a.errMsg = "getNetworkType:ok", c = a.subtype,
						delete a.subtype, c)
						a.networkType = c;
					else
					...
					return a._complete = function(a) {
						...
						if (b) {
							for ( b = JSON.parse(b), c = 0, d = b.length; d > c; ++c)
								e = b[c], e.cardId = e.card_id, e.cardExt = e.card_ext, e.isSuccess = e.is_succ ? !0 : !1,
								delete e.card_id,
								delete e.card_ext,
								delete e.is_succ;
							a.cardList = b,
